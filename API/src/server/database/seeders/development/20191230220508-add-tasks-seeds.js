  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("tasks", [
      ...
      },
      {
        ...
        type: "Idea",
        identifier: "ENV-5",
        title: "Create HTML template of sprint page based on graphic project.",
        points: 5,
        priority: "Normal",
        state: "Awaiting"
      },
      ...
      },
      {
        ...
        state: "To do",
        title:
          "Fix problems caused by sequelize.",
        identifier: "ENV-12",
        points: 2,
        priority: "Normal",
        type: "Bug",
      ...
      },
      {
        ...
        state: "To do",
        title:
          "Config sentry to send error messages to the server.",
        identifier: "ENV-13",
        points: 4,
        priority: "High",
        type: "Improvement",
      ...
      },
      {
        ...
        state: "To do",
        title:
          "Dialog windows not showing up internet explorer.",
        identifier: "ENV-14",
        points: 2,
        priority: "Normal",
        type: "Bug",
